...
if (isset($_GET['delete'])) {
    mysqli_query($conn, "DELETE FROM task where id=" . mysqli_real_escape_string($conn, $_GET['delete']) . ";");
}
?>
<!DOCTYPE html>
<html lang = "en">
...
?><span class="caret"></span></a>
    ...
    <div class="container">
        ...
        <?php
        echo '<table><tr><th class="col-md-5">Name</th><th class="col-md-5">Salary_hour</th><th class="col-md-1"></th><th class="col-md-1"></th></tr>';
        ...
        if (isset($_GET['add'])) {
            ...
            <form method="POST">
                <?php
                echo "<tr>";
                echo "<td class='col-md-5'><input type='text' name='name'></td>";
                echo "<td class='col-md-5'><input type='text' name='salary_hour'></td>";
            ...
            if (isset($_POST['submit2'])) {
                ...
                $sql = "insert into task (task_name, salary_hour) values('$name', $salary_hour);";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            if ($row['id'] == $_GET['edit']) {
                ...
                <form action="editTask.php" method="POST">
                    ...
                    <?php
                    echo "<tr>";
                    echo "<td class='col-md-5'><input type='text' name='name' size='10' value='" . $row['task_name'] . "'></td>";
                    echo "<td class='col-md-5'><input type='text' name='salary_hour' size='10' value='" . $row['salary_hour'] . "'></td>";
                ...
                echo "<tr>";
                echo "<td class='col-md-5'>" . $row['task_name'] . "</td>";
                echo "<td class='col-md-5'>" . $row['salary_hour'] . "</td>";
                echo "<td class='col-md-1'>";
                ?> 
                <div class="edit">
                    <?php echo '<a href="task.php?edit=' . $row['id'] . '">'; ?>
                ...
                <div class="remove"> 
                    ...
                    <?php echo '<a href="task.php?delete=' . $row['id'] . '">'; ?>
